...
hslider bounds(192, 200, 150, 50) channel("rndFrq") range(0, 1000, 300, 1, 0.001) text("FltRndStNd") textColour("white")
...
aSig       butterbp  aNoise, chnget:k("ControlX") * k2, chnget:k("ControlY") * kBW, 1
