...
button  bounds(336, 8, 100, 40)   channel("datrigger") text("MyTrigger") textColour("white")
...
gi4strtHi = chnget:i("maxDur")-gi3durHi
        ...
        event_i "i", 6, istrt1, idur1, iamp, ifreq1, ipan1
        event_i "i", 6, istrt2, idur2, iamp, ifreq2, ipan2
        event_i "i", 6, istrt3, idur3, iamp, ifreq3, ipan3
        event_i "i", 6, istrt4, idur4, iamp, ifreq4, ipan4
