...
checkbox bounds(46, 214, 27, 25), channel("reTrigger"), , fontColour:0(255, 255, 255, 255)
label    bounds(2, 186, 114, 21), text("ReTrigger"), fontColour(255, 255, 255, 255) channel("label9")


hslider bounds(4, 246, 175, 50) channel("rate") range(.02, 20, 8, 1, 0.001) text("ReTrig Rate") textColour("white")
</Cabbage>
<CsoundSynthesizer>
<CsOptions>
-n -dm0
...
aL             =        a1 + a3
aR             =        a2 + a4
aclipL         clip     aL, 0, 0.8
aclipR         clip     aR, 0, 0.8

              outs      aclipL * chnget:k("masterLvl"), aclipR * chnget:k("masterLvl")
