...
checkbox bounds(370, 368, 27, 29), channel("reTrigger"), , fontColour:0(255, 255, 255, 255)
label    bounds(230, 372, 114, 19), text("ReTrigger"), fontColour(255, 255, 255, 255) channel("label9")


hslider bounds(34, 348, 175, 50) channel("rate") range(.02, 20, 4, 1, 0.001) text("ReTrig Rate") textColour("white")
</Cabbage>
