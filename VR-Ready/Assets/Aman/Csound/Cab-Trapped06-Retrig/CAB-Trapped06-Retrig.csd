...
hslider bounds(28, 360, 125, 34) channel("rate") range(.6, 17, 10, 1, 0.001) text("Rate") textColour("white")
...
checkbox bounds(92, 334, 27, 29), channel("reTrigger"), , fontColour:0(255, 255, 255, 255)
label    bounds(0, 338, 106, 17), text("ReTrigger"), fontColour(255, 255, 255, 255) channel("label9")


hslider bounds(184, 204, 125, 34) channel("rate") range(.02, 20, 3, 1, 0.001) text("ReTrig Rate") textColour("white")
</Cabbage>
</Cabbage>
